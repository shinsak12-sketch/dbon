...
/** 공통 JSON GET (content-type 검사 포함) */
...
export default function Admin() {
  ...
  useEffect(() => {
    safeGetJSON("/api/admin/background", {}).then((d) =>
      setBgUrl(d?.url || "")
    );
  }, []);
  ...
  const [evForm, setEvForm] = useState({
    ...
    name: "", // 대회명
    manager: "", // 부서담당자
    beginAt: "", // 시작 (datetime-local)
    endAt: "", // 종료 (datetime-local)
    tier: 100, // 120/100/80
  ...
  async function loadEvents() {
    ...
    const norm = arr.map((e) => ({
      ...
      name: e.name ?? e.title ?? "",
      manager: e.manager ?? "",
      beginAt: e.beginAt ?? e.playedAt ?? null,
      endAt: e.endAt ?? null,
      tier: e.tier ?? 100,
  ...
  function editEvent(e) {
    setEvForm({
      ...
      name: e.name || "",
      manager: e.manager || "",
      beginAt: toLocalInput(e.beginAt),
  ...
  async function search() {
    ...
    try {
      const r = await fetch(
        `/api/admin/champ/participants?q=${encodeURIComponent(
          q
        )}&admin=${ADMIN_PASS}`
      );
      const data = await r.json();
  ...
  const chevron = (on) => (
    <span className={`ml-2 transition-transform ${on ? "rotate-180" : ""}`}>
      ▾
    </span>
  );
          ...
          <div className="p-5 pt-0 space-y-4">
            <div className="grid gap-3">
              <input
                ...
                placeholder="몇회 (예: 제1회)"
                value={evForm.roundNo}
                onChange={(e) =>
                  setEvForm((v) => ({ ...v, roundNo: e.target.value }))
                }
              />
              <select
                className="border rounded-lg p-3"
                ...
                onChange={(e) =>
                  setEvForm((v) => ({ ...v, organizer: e.target.value }))
                }
              >
              ...
              <input
                ...
                value={evForm.name}
                onChange={(e) =>
                  setEvForm((v) => ({ ...v, name: e.target.value }))
                }
              />
              <select
                className="border rounded-lg p-3"
                value={evForm.classType}
                onChange={(e) =>
                  setEvForm((v) => ({ ...v, classType: e.target.value }))
                }
              >
                {classTypes.map((t) => (
              ...
              <input
                ...
                onChange={(e) =>
                  setEvForm((v) => ({ ...v, manager: e.target.value }))
                }
              />
              <div className="grid gap-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEvForm((v) => ({ ...v, beginAt: e.target.value }))
                  }
                />
                ...
                <input
                  ...
                  value={evForm.endAt}
                  onChange={(e) =>
                    setEvForm((v) => ({ ...v, endAt: e.target.value }))
                  }
                />
              </div>
              <select
                ...
                value={evForm.tier}
                onChange={(e) =>
                  setEvForm((v) => ({ ...v, tier: Number(e.target.value) }))
                }
              >
              ...
              <select
                ...
                value={evForm.state}
                onChange={(e) =>
                  setEvForm((v) => ({ ...v, state: e.target.value }))
                }
              >
              ...
              <select
                ...
                value={evForm.mode}
                onChange={(e) =>
                  setEvForm((v) => ({ ...v, mode: e.target.value }))
                }
              >
              ...
              <select
                ...
                value={evForm.adjust}
                onChange={(e) =>
                  setEvForm((v) => ({ ...v, adjust: e.target.value }))
                }
              >
              ...
              <textarea
                ...
                onChange={(e) =>
                  setEvForm((v) => ({ ...v, overview: e.target.value }))
                }
              />
            </div>
                ...
                >
                  <div className="min-w-0">
                    ...
                    <div className="text-xs text-gray-500">
                      {e.organizer || "-"} ·{" "}
                      {e.beginAt
                        ? new Date(e.beginAt).toLocaleString("ko-KR")
                        : "일정 미정"}{" "}
                      · 티어 {e.tier ?? 100}
                    </div>
                  </div>
        ...
        {open.notice && (
          <div className="p-5 pt-0 space-y-4">
            <input
              ...
              value={ntForm.title}
              onChange={(e) =>
                setNtForm((v) => ({ ...v, title: e.target.value }))
              }
            />
            <textarea
              className="w-full border rounded-lg p-3"
              ...
              onChange={(e) =>
                setNtForm((v) => ({ ...v, content: e.target.value }))
              }
            />
            <label className="inline-flex items-center gap-2">
              <input
                ...
                onChange={(e) =>
                  setNtForm((v) => ({ ...v, pinned: e.target.checked }))
                }
              />{" "}
              상단 고정
            </label>
                  ...
                  <div key={k} className="mt-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setPointRules((v) => ({
                          ...v,
                          tier: { ...v.tier, [k]: Number(e.target.value) },
                        }))
                      }
                    />
                  </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        onClick={() =>
                          resetPassword(
                            p.id,
                            document.getElementById(`tpw-${p.id}`).value
                          )
                        }
